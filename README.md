...
| **Feb 17-23**    | No class <br> (President's Day) |      |    |    Project 3 Released <br> (Routing, ECMP)                ||      | Project 2 Due |
...
| **Apr 20-26**    |       WAN (wide-area networking) `Scribe`                                                                                                                                                                                            |      | Cloud applications III (perf isolation)`Scribe`                                        |                                      |                                       Final project suggestions       | | project 8  due
