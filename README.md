...
## ***Announcement***
- **[2022/01/14] New x86 VM link is updated in [intrastructure setup](https://github.com/minlanyu/cs145-site/blob/spring2023/infra.md). This solves the problem that the previous VM cannot be run in VMware and also some libraries are fixed.**
- **[2022/01/14] [Project 0](https://classroom.github.com/a/i8-2KYy6) README (project description) is updated. Please check the new requirement for Project 0. Thanks!**
